        ...
        <div className="pt-4 flex flex-wrap justify-center gap-2">
          {KRTMI_STORIES.map((story) => (
            <a
              ...
              className="px-3.5 py-1.5 rounded-xl bg-[#140E09] border border-[#2B1B10] text-amber-200/80 hover:text-white hover:border-brand-orange/60 text-xs font-bold transition flex items-center space-x-1.5"
            >
      ...
      <div className="space-y-16">
        {KRTMI_STORIES.map((story) => (
          <div
            key={story.year}
            id={`tahun-${story.year}`}
            className="p-6 sm:p-10 rounded-3xl bg-[#140E09] border-2 border-brand-orange/30 shadow-2xl space-y-8 relative overflow-hidden scroll-mt-24"
          >
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6 sm:gap-8 border-b border-[#2A1B10] pb-6">
              ...
              <div className="flex-1 space-y-3 text-center md:text-left">
                <div className="flex flex-wrap items-center justify-center md:justify-start gap-2">
                  ...
                  <span className="px-3 py-1 rounded-full text-xs font-black uppercase bg-brand-orange/20 text-brand-orange border border-brand-orange/40">
                    Edisi {story.year}
                  </span>
                  {story.isChampion && (
                    <span className="px-3 py-1 rounded-full text-xs font-extrabold bg-amber-500/20 text-brand-gold border border-amber-500/40 flex items-center space-x-1">
                ...
                {story.slogan && (
                  <div className="text-[11px] font-mono italic text-amber-300/70">
            ...
            {/* Achievement Badge */}
            <div className="p-4 rounded-2xl bg-[#0C0805] border border-brand-orange/40 flex items-center space-x-3 shadow-inner">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
              <div className="p-3.5 rounded-xl bg-[#0A0704] border border-[#241508] text-center space-y-1">
              ...
              <div className="p-3.5 rounded-xl bg-[#0A0704] border border-[#241508] text-center space-y-1">
                ...
                <span className="text-xs sm:text-sm font-black text-brand-orange block truncate" title={story.matchProcedure?.victoryCondition}>
              ...
              <div className="p-3.5 rounded-xl bg-[#0A0704] border border-[#241508] text-center space-y-1">
                ...
                <span className="text-xs sm:text-sm font-black text-cyan-200 block truncate" title={story.robotSpecs.robotCount || '1 Robot'}>
                ...
                <div className="space-y-2.5">
                  ...
                  {story.arenaSpecs.obstacles && (
                    <div>
                      ...
                      <span className="text-amber-300">{story.arenaSpecs.obstacles}</span>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="p-5 rounded-2xl bg-[#0A0704] border border-[#241508] space-y-3 text-xs">
                ...
                <div className="space-y-2.5">
                  ...
                  <div>
                    ...
                    <span className="text-amber-200">{story.robotSpecs.controller} • {story.robotSpecs.mechanism}</span>
                  </div>
            ...
            <div className="p-5 rounded-2xl bg-[#0C0805] border border-[#26180E] space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-slate-300">
                {story.teamRoleAndFunFacts.map((fact, idx) => (
                  <div key={idx} className="flex items-start space-x-2 p-3 rounded-xl bg-[#140E09] border border-[#241508]">
            ...
            <div className="p-5 rounded-2xl bg-[#0C0805] border border-brand-orange/40 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-xl">
              <div className="flex items-center space-x-3.5">
                <div className="w-12 h-12 rounded-2xl bg-red-500/20 text-red-400 flex items-center justify-center border border-red-500/30 flex-shrink-0">
              ...
              >
                ...
                <span>Unduh PDF Buku Panduan Resmi</span>
              </a>
            </div>

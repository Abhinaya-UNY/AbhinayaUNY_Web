...
target = r"D:\Data_Lokal\Kuliah\Tri Wahyu (22518241023)\AbhinayaUNY_Web\.agents\teamwork_preview_reviewer_1\handoff.md"

lines = [
    "# Review & Adversarial Challenge Report — Reviewer 1",
    "",
    "**Agent:** 	eamwork_preview_reviewer_1 (Reviewer / Adversarial Critic)  ",
...
pm.cmd run build)",
    ...
    "",
    "### 1.5. Adversarial Audit Execution (udit_adversarial.py)",
    "- Total NIMs in 	eamData.ts: 41 (Unique: 34, Non-11-digit: 0).",
    "- Total image paths in 	eamData.ts: 241 (Unique: 92, Missing: 0, Corrupt/black: 0).",
    ...
    "   The synchronization between 	eamData.ts, UI components (TeamRosterSection.tsx, MemberPhotoFadeEngine.tsx), and markdown documentation is total and consistent. Dynamic counts prevent category drift. Next.js production build completes with 0 errors across all 11 static routes.",
    "",

...
export const TEAM_MEMBERS: TeamMember[] = [
  ...
  {
    id: 'audit-test-member',
    name: 'Auditor Test Engineer',
    nim: '99999999999',
    studyProgram: 'S1 Teknik Mekatronika',
    faculty: 'Fakultas Teknik (FT)',
    division: 'Programming & AI',
    role: 'Audit Verification Specialist',
    specialization: ['Integrity Testing', 'Forensic Analysis'],
    bio: 'Temporary audit verification entry for testing manager_tool.py backup and restore.',
    image: '/assets/logo_abhinaya_solid.png',
    badge: 'Auditor',
  },
];

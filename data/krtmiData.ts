...
export const TEAM_DIVISIONS: TeamDivision[] = [
  {
    id: 'mekanik',
    name: 'Divisi Mekanik (Rangka & Bodi)',
    icon: 'Wrench',
    desc: 'Bertanggung jawab atas rangka dan fisik robot. Mulai dari mendesain model 3D, merakit roda mecanum, membuat lengan capit (gripper), hingga proses cetak 3D print dan perakitan logam sasis.',
    skills: ['Desain 3D CAD', 'Perakitan Sasis Roda Mecanum', '3D Printing Komponen', 'Lengan Capit & Gripper'],
  },
  {
    id: 'elektrik',
    name: 'Divisi Elektrik (Kelistrikan & Daya)',
    icon: 'Zap',
    desc: 'Bertanggung jawab atas aliran listrik dan tenaga robot. Mendesain jalur PCB, menyolder komponen, mengatur baterai dan modul penggerak motor, serta merangkai sensor agar robot bergerak stabil dan aman.',
    skills: ['Desain PCB & Solder Komponen', 'Driver Motor & Baterai Robot', 'Rangkaian Sensor Arena', 'Pengkabelan Rapi & Aman'],
  },
  {
    id: 'programming',
    name: 'Divisi Pemrograman & AI (Otak Robot)',
    icon: 'Code',
    desc: 'Mengisi logika dan otak robot agar bisa bergerak otomatis. Menulis kodingan program (C/C++), mengatur kecepatan motor roda, serta melatih kamera pintar (AI) agar robot bisa mengenali barang di arena.',
    skills: ['Koding Mikrokontroler (ESP32/STM32)', 'Kendali Otomatis (PID Tuning)', 'Kamera Pintar & Deteksi AI (YOLO)', 'Komunikasi Wireless Robot'],
  },
  {
    id: 'manajerial',
    name: 'Divisi Manajerial & Media',
    icon: 'Users',
    desc: 'Mengurus kebutuhan operasional dan publikasi tim. Mengelola administrasi lomba, pengadaan barang riset, pembuatan konten foto & video, serta mengelola media sosial resmi @abhinaya.uny.',
    skills: ['Manajemen Jadwal & Anggaran', 'Konten Foto & Video Dokumentasi', 'Media Sosial Resmi (@abhinaya.uny)', 'Logistik & Kebutuhan Tim'],
  },
];

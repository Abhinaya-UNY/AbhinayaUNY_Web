  ...
  return (
    <div className="min-h-screen bg-[#0B0B0E] text-slate-100 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-16 relative overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 pointer-events-none flex items-center justify-center opacity-30">
        <div className="w-[650px] h-[650px] bg-orange-500/10 rounded-full blur-[140px]" />
      </div>
      ...
      <div className="relative z-10 max-w-2xl w-full p-8 sm:p-12 rounded-3xl bg-[#121216] border border-white/15 backdrop-blur-2xl shadow-2xl text-center space-y-8">
        ...
        <div className="flex items-center justify-between border-b border-white/8 pb-4 text-xs font-mono text-orange-400">
          <div className="flex items-center space-x-2">
            <span className="w-2.5 h-2.5 rounded-full bg-orange-500 animate-ping" />
            <span className="text-orange-400 font-bold uppercase tracking-wider">STATUS // 500 FAILSAFE ENGAGED</span>
          </div>
        ...
        <div className="space-y-4">
          <div className="inline-flex p-4 rounded-2xl bg-orange-500/10 border border-orange-500/30 text-orange-400 shadow-orange-glow">
        ...
        <div className="p-4 rounded-2xl bg-[#18181B] border border-white/8 text-left font-mono text-xs space-y-1.5 text-slate-300">
          <div className="flex items-center space-x-2 text-orange-400 text-[11px] pb-1 border-b border-white/5">
          ...
          <p className="text-orange-400">• [RECOVERY] Jalur pemulihan subsistem siap diarahkan ulang...</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
          <Link
            href="/"
            className="flex items-center justify-center space-x-2 px-5 py-3.5 rounded-2xl bg-orange-500 hover:bg-orange-400 text-black font-bold text-sm shadow-orange-glow transition cursor-pointer"
          >

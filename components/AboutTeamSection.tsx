...
export const AboutTeamSection: React.FC = () => {
  ...
  return (
    <section id="about-tim" className="py-20 space-y-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="text-center space-y-3 max-w-3xl mx-auto">
          ...
          <h2 className="text-3xl sm:text-5xl font-black text-white tracking-tight">
            Mengenal Keluarga Tim Robotika Abhinaya 🛠️
          </h2>
          <p className="text-xs sm:text-base text-slate-300">
            Tim Abhinaya adalah salah satu tim robotika resmi di bawah naungan Fakultas Teknik Universitas Negeri Yogyakarta yang berkompetisi di divisi <strong>Kontes Robot Tematik Indonesia (KRTMI)</strong>.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-6 text-sm text-slate-300 leading-relaxed">
            ...
            <div className="pt-2 flex flex-wrap gap-3">
              <div className="p-3.5 rounded-2xl bg-[#140E09] border border-[#2B1B10] text-xs space-y-0.5">
